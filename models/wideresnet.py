...
class WideResNet(nn.Module):
    def __init__(self, num_classes, depth=28, widen_factor=2, drop_rate=0.0, bias=True):
        ...
        self.fc = nn.Linear(channels[3], num_classes, bias=bias)
...
def build_wideresnet(depth, widen_factor, dropout, num_classes, open=False, bias=True):
